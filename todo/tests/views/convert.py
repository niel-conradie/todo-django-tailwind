...
from todo.views import task_convert_view


CustomUser = get_user_model()


class TaskConvertViewTests(TestCase):
    """
    The TaskConvertViewTests class is a test case class for testing the functionality of an task convert view.
    ...
    def setUp(self):
        ...
        self.url = reverse_lazy("todo:convert")
