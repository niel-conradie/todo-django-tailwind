...
from todo.views import task_delete_view
...
class TaskDeleteViewTests(TestCase):
    """
    The TaskDeleteViewTests class is a test case class for testing the functionality of an task delete view.
    ...
    def setUp(self):
        ...
        self.url = reverse_lazy("todo:delete")
